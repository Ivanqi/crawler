...
// newIllegalParameterError 会创建一个 newIllegalParameterError 类型的实例
...
// newIllegalPairTypeError 会创建一个 IllegalPairTypeError 类型的实例
...
// newPairRedistributorError 会创建一个 PairRedistributorError 类型的实例
